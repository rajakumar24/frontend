...
class App extends React.Component {
  ...
  _getCode = async () => {
    ...
    await axios
      .get("http://getrightproperty.com:3001/api/profile/otp", {
        params: {
          email: email,
          phone: phone,
    ...
    // await axios.get("http://getrightproperty.com:3001:3000/api/profile/all")
    //     .then(data => {
  ...
  _verifyCode = async () => {
    ...
    // console.log("iddd", id)
    await axios
      .get("http://getrightproperty.com:3001/api/profile/verify", {
        params: {
          id: id,
          token: token,
        },
